...
(cl:in-package vulcan_mavros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vulcan_mavros-srv:<AddTwoInts-request> is deprecated: use vulcan_mavros-srv:AddTwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vulcan_mavros-srv:a-val is deprecated.  Use vulcan_mavros-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vulcan_mavros-srv:b-val is deprecated.  Use vulcan_mavros-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInts-request>)))
  ...
  "vulcan_mavros/AddTwoIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInts-request)))
  "Returns string type for a service object of type 'AddTwoInts-request"
  "vulcan_mavros/AddTwoIntsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vulcan_mavros-srv:<AddTwoInts-response> is deprecated: use vulcan_mavros-srv:AddTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vulcan_mavros-srv:sum-val is deprecated.  Use vulcan_mavros-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddTwoInts-response>)))
  ...
  "vulcan_mavros/AddTwoIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddTwoInts-response)))
  "Returns string type for a service object of type 'AddTwoInts-response"
  "vulcan_mavros/AddTwoIntsResponse")
