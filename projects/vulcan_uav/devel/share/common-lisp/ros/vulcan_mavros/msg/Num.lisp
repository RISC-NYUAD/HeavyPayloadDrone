...
(cl:in-package vulcan_mavros-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vulcan_mavros-msg:<Num> is deprecated: use vulcan_mavros-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vulcan_mavros-msg:num-val is deprecated.  Use vulcan_mavros-msg:num instead.")
  (num m))
